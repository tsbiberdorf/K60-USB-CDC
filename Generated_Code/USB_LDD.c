...
#define MAX_EP_IDX                                0x07u
#define MAX_BD_IDX                                0x0Fu
...
typedef struct USB_LDD_TDeviceData_Struct {
  ...
  USB_LDD_TTD                      EP_2_OUT_dTD_Queue[0x01U];
  USB_LDD_TTD                      EP_3_IN_dTD_Queue[0x01U];
...
static void USB_LDD_DeviceDisableAllEp(USB_LDD_TDeviceData *DevDataPtr)
{
  ...
  DevDataPtr->EpData[0x04u].EpState      = USB_LDD_EP_NOT_CONFIGURED;
  DevDataPtr->EpData[0x04u].EpNumber     = 0x02U;
  DevDataPtr->EpData[0x04u].TDQueuePtr   = &DevDataPtr->EP_2_OUT_dTD_Queue[0];
  DevDataPtr->EpData[0x04u].EpCtrlRegPtr = USB_PDD_GetEpCtrlRegAddr(USB0_BASE_PTR, 0x02U);
  DevDataPtr->EpData[0x04u].BDPtr        = &DevDataPtr->BDT[0x08U];
  DevDataPtr->EpData[0x05u].TransferType = LDD_USB_BULK;
  DevDataPtr->EpData[0x06u].TransferType = LDD_USB_BULK;
  DevDataPtr->EpData[0x07u].EpState      = USB_LDD_EP_NOT_CONFIGURED;
  DevDataPtr->EpData[0x07u].EpNumber     = 0x03U;
  DevDataPtr->EpData[0x07u].TDQueuePtr   = &DevDataPtr->EP_3_IN_dTD_Queue[0];
  DevDataPtr->EpData[0x07u].EpCtrlRegPtr = USB_PDD_GetEpCtrlRegAddr(USB0_BASE_PTR, 0x03);
  DevDataPtr->EpData[0x07u].BDPtr        = &DevDataPtr->BDT[0x0Eu];
}
